...
% Optionally load your local logo set by uncommenting and editing the
% following line.

% \AFESBrandLogoLoad{esadelaide}
...
%
% Additionally, a Google Chrome extension is available to simplify downloading
% the output files and to copy the SVG and PNG to clipboard.
