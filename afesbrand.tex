...
The following functions can have inner functions options set:
\cs{AFESBrandEmailSignature}, \cs{AFESBrandFrameDevice},
\cs{AFESBrandGridSystem}, \cs{AFESBrandWaveEffect}.
